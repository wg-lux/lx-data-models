...
TEST_EXPORT = GENERATED_TEST_OUTPUT_ROOT / "examination_fixture.yaml"
TEST_EXPORT_DDICT_SCHEMA = GENERATED_TEST_OUTPUT_ROOT / "examination_ddict_schema.yaml"
...
class TestExaminationTypeFixture:
    def test_examination_type_fixture(
        ...
        examination_type_fixture.to_yaml(
            GENERATED_TEST_OUTPUT_ROOT / "examination_type_fixture.yaml"
        )
    ...
    def test_dump_examination_type_ddict(
        ...
        dump_ddict_schema(
            ddict_type,
            GENERATED_TEST_OUTPUT_ROOT / "examination_type_ddict_schema.yaml",
        )
