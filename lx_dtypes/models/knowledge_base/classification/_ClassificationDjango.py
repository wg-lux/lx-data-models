...
class ClassificationDjango(KnowledgebaseBaseModelDjango[ClassificationDataDict]):
    classification_types: "models.ManyToManyField[ClassificationTypeDjango, ClassificationTypeDjango]" = models.ManyToManyField(
        "ClassificationTypeDjango", related_name=FieldNames.CLASSIFICATIONS.value
    )
    classification_choices: "models.ManyToManyField[ClassificationChoiceDjango, ClassificationChoiceDjango]" = models.ManyToManyField(
        "ClassificationChoiceDjango",
