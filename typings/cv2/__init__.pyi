# pyright: reportAttributeAccessIssue=false, reportOverlappingOverload=false, reportIncompatibleMethodOverride=false
...
class CalibrateDebevec(CalibrateCRF):
    ...
    def setSamples(self, samples: int) -> None: ...  # noqa: F811
...
class BFMatcher(DescriptorMatcher):
    ...
    @classmethod
    def create(cls, normType: int = ..., crossCheck: bool = ...) -> BFMatcher: ...  # type: ignore[override]
...
class FlannBasedMatcher(DescriptorMatcher):
    ...
    @classmethod
    def create(cls) -> FlannBasedMatcher: ...  # type: ignore[override]
...
class Animation:
    ...
    # Functions
    def __init__(
        self, loopCount: int = ..., bgColor: cv2.typing.Scalar = ...
    ) -> None: ...
...
class TrackerDaSiamRPN(Tracker):
    ...
    @_typing.overload
    def create(
        cls, siam_rpn: cv2.dnn.Net, kernel_cls1: cv2.dnn.Net, kernel_r1: cv2.dnn.Net
    ) -> TrackerDaSiamRPN: ...
...
@_typing.overload
def calcCovarMatrix(
    samples: cv2.typing.MatLike,  # noqa: F811
    mean: cv2.typing.MatLike,
    flags: int,
...
def imdecodeWithMetadata(
    ...
    cv2.typing.MatLike, _typing.Sequence[int], _typing.Sequence[cv2.typing.MatLike]
]: ...
@_typing.overload
def imdecodeWithMetadata(
...
@_typing.overload
def imdecodeanimation(
    buf: cv2.typing.MatLike, start: int = ..., count: int = ...
) -> tuple[bool, Animation]: ...
@_typing.overload
def imdecodeanimation(
    buf: UMat, start: int = ..., count: int = ...
) -> tuple[bool, Animation]: ...
@_typing.overload
def imdecodemulti(
    buf: cv2.typing.MatLike,
...
@_typing.overload
def imreadWithMetadata(
    filename: str, metadata: _typing.Sequence[UMat] | None = ..., flags: int = ...
) -> tuple[cv2.typing.MatLike, _typing.Sequence[int], _typing.Sequence[UMat]]: ...
def imreadanimation(
...
class _VideoWriterFourCC(Protocol):
    def __call__(self, c1: int, c2: int, c3: int, c4: int, /) -> int: ...

def VideoWriter_fourcc(c1: int, c2: int, c3: int, c4: int, /) -> int: ...
